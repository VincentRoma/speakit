...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/EduSpeakBundle/Entity'))), 'EduSpeakBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('EduSpeakBundle' => 'EduSpeakBundle\\Entity'));
